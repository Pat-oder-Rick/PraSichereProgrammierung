...
public class LoginView extends VerticalLayout {
	...
	public void login() {
			...
			if (DBController.login(usernameField.getValue(), passwordField.getValue())) {
				printLoggedIn();
			} 
		}
	...
	public void createAccount() throws UnsupportedEncodingException {
		if (DBController.checkDuplicate(usernameField.getValue()) != true){
			DBController.createAccount(usernameField.getValue(), passwordField.getValue());
			printLogin();
			}
		}
